          ...
          <Col size={12} sm={6}>
            ...
            {/* The first section contains a paragraph with the text "Click Like" and a "Like" button represented by a HandThumbsUpFill icon. 
                  ...
                  <div className="social-icon">
                    <a href="https://www.linkedin.com/in/yichizhang54" aria-label="LinkedIn profile"><img src={navIconLinkedIn} alt="LinkedIn" /></a>
                    <a href="https://github.com/WhiteMasky" aria-label="GitHub profile"><img src={navIconGithub} alt="GitHub" /></a>
                    <a href="https://www.youtube.com/channel/UC5jq2ipvNFnFPE2v_zbdZBw" aria-label="YouTube channel"><img src={navIconYoutube} alt="YouTube" /></a>
                    <a href="https://www.facebook.com/YichiZhang0504" aria-label="Facebook profile"><img src={navIconFacebook} alt="Facebook" /></a>
